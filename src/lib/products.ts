...
export const products: Product[] = [
  // XX99 Mark II Headphones
  {
    ...
    others: [
      { slug: "xx99-mark-one-headphones", name: "XX99 Mark I", image: "/assets/shared/desktop/image-xx99-mark-one-headphones.jpg" },
      { slug: "xx59-headphones", name: "XX59", image: "/assets/shared/desktop/image-xx59-headphones.jpg" },
      { slug: "zx9-speaker", name: "ZX9 Speaker", image: "/assets/shared/desktop/image-zx9-speaker.jpg" },
    ],
    image: {
  ...
  // XX99 Mark I Headphones
  {
    ...
    features: "As the headphones all others are measured against, the XX99 Mark I demonstrates over five decades of audio expertise, redefining the critical listening experience. These closed-back headphones are built with the finest materials to ensure maximum durability.\n\nThe detachable cables provide excellent connectivity, while the soft earpads ensure long-lasting comfort. Experience unrivalled sound quality and a truly immersive listening experience with the XX99 Mark I.",
    includes: [
      { quantity: 1, item: "Headphone unit" },
      { quantity: 2, item: "Replacement earcups" },
      { quantity: 1, item: "User manual" },
    ...
    others: [
      { slug: "xx99-mark-two-headphones", name: "XX99 Mark II", image: "/assets/shared/desktop/image-xx99-mark-two-headphones.jpg" },
      { slug: "xx59-headphones", name: "XX59", image: "/assets/shared/desktop/image-xx59-headphones.jpg" },
      { slug: "zx9-speaker", name: "ZX9 Speaker", image: "/assets/shared/desktop/image-zx9-speaker.jpg" },
    ],
    image: {
  ...
  // ZX9 Speaker
  {
    ...
    others: [
      { slug: "zx7-speaker", name: "ZX7 Speaker", image: "/assets/shared/desktop/image-zx7-speaker.jpg" },
      { slug: "xx99-mark-one-headphones", name: "XX99 Mark I", image: "/assets/shared/desktop/image-xx99-mark-one-headphones.jpg" },
      { slug: "xx59-headphones", name: "XX59", image: "/assets/shared/desktop/image-xx59-headphones.jpg" },
    ],
    image: {
  ...
  // ZX7 Speaker
  {
    ...
    features: "Reap the advantages of a flat diaphragm tweeter cone. This provides a fast response rate and excellent high frequencies that lower tiered bookshelf speakers cannot provide. The woofers are made from aluminum that produces a unique and clear sound. XLR inputs allow you to connect to a mixer for more advanced usage.\n\nThe ZX7 speaker is the perfect blend of stylish design and high-fidelity sound. Featuring a minimalist aesthetic, these speakers fit seamlessly into any environment. The room-filling stereo sound provides you with an unmatched listening experience.",
    includes: [
      { quantity: 2, item: "Speaker unit" },
      { quantity: 2, item: "Speaker cloth panel" },
      { quantity: 1, item: "User manual" },
